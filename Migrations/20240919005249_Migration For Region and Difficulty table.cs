...
{
    /// <inheritdoc />
    public partial class MigrationForRegionandDifficultytable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("506b5853-2d3b-477b-95b4-67294cf27a3d"), "Medium" },
                    { new Guid("723f02fb-89d1-48fd-94bf-cc191f989374"), "Hard" },
                    { new Guid("df2bc1f2-4acf-438d-aa55-83b6d8e99592"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "ID",
                keyValue: new Guid("506b5853-2d3b-477b-95b4-67294cf27a3d"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "ID",
                keyValue: new Guid("723f02fb-89d1-48fd-94bf-cc191f989374"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "ID",
                keyValue: new Guid("df2bc1f2-4acf-438d-aa55-83b6d8e99592"));
